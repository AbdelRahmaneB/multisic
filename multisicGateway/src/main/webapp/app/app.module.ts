...
import { MultisicGatewaySharedModule, UserRouteAccessService } from './shared';
import { MultisicGatewayAppRoutingModule} from './app-routing.module';
...
@NgModule({
    imports: [
        BrowserModule,
        MultisicGatewayAppRoutingModule,
...
export class MultisicGatewayAppModule {}
