package ca.polymtl.multisic.web.rest;

import ca.polymtl.multisic.MultisicServiceApp;

import ca.polymtl.multisic.domain.PlayList;
import ca.polymtl.multisic.repository.PlayListRepository;
import ca.polymtl.multisic.web.rest.errors.ExceptionTranslator;
...
import static ca.polymtl.multisic.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = MultisicServiceApp.class)
