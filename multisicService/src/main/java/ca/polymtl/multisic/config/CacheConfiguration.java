package ca.polymtl.multisic.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("multisicService");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("multisicService");
        ...
        config.getMapConfigs().put("ca.polymtl.multisic.domain.*", initializeDomainMapConfig(jHipsterProperties));
